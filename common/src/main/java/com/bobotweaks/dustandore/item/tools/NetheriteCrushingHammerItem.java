...
public class NetheriteCrushingHammerItem extends Item {
	public NetheriteCrushingHammerItem(Item.Properties properties) {
	...
	public Component getName(ItemStack stack) {
		return Component.translatable(this.getDescriptionId())
				.withStyle(style -> style.withColor(0xC53335));
	}
